...
public enum WsDestinoEnum {
    ...
    private static WsDestinoProperty properties;
    private String cachedPath; 

    private WsDestinoEnum(String propName) {
    ...
    public static void init(WsDestinoProperty props) {
        properties = props;
        for (WsDestinoEnum destino : values()) {
            destino.loadPath();
        }
    ...
    private void loadPath() {
        ...
        try {
            ...
            for (int i = 0; i < propNames.length; i++) {
                ...
                if (current instanceof WsDestinoProperty destProps) {
